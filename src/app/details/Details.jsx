...
function Details() {
  ...
  if(!hotel) return (
    <div className="grid min-h-dvh place-content-center">
      <Spinner className="size-24 text-gray-200 fill-blue-500 animate-spin" /></div>
  ) 
  ...
  return (
    <div>
      ...
      <div className="max-w-5xl max-[1024px]:px-4 mx-auto pb-7"> 
      <div className="py-10">
        {isAuth ? (
        ...
        <div className="h-full order-1 sm:order-2">
